...
////////////////////    
DrawingTools draw("res/nd280Highland2_v2r45_1_data.root");
DataSample data("res/nd280Highland2_v2r45_1_data.root");
DataSample mc("res/nd280Highland2_v2r45_1_MC.root");
...
auto Func = new TF1("myfunc", myfunction, -0.5, 0.5, 6);
Func->SetLineColor(2);
...
float p3e = Func->GetParError(3);
float p4 = Func->GetParameter(4);
float p4e = Func->GetParError(4);
...
<<"	\\hline \n"
<<"\\end{tabular}\n"
<<"\\caption{Parameters of distribution } \\vspace{0.2in}\n"
<<"\\label{xxx}\n"
<<"\\end{center}\n"
<<"\\end{table}\n"
<<std::endl;
